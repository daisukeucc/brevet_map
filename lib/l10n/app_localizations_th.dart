...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get gpxExportSaveLocationMessage =>
      'โดยค่าเริ่มต้น ไฟล์ที่ส่งออกจะถูกบันทึกตามตำแหน่งต่อไปนี้\n\niOS:\n[iPhone ของฉัน] > [Brevet MAP]\n\nAndroid:\n[Files] > [ดาวน์โหลด]';
  ...
  String get releaseNotesV13020Message =>
      'เวอร์ชัน 1.3 เพิ่มฟีเจอร์เช็กอิน ช่วยให้คุณบันทึกผลการปั่นจริงที่แต่ละ POI ได้!\nเปรียบเทียบกับแผนที่วางไว้เพื่อดูว่าคุณนำหน้าหรือล้าหลังแค่ไหน และปรับเพซได้อย่างเหมาะสม\nเวอร์ชันนี้เปิดใช้งานทุกฟีเจอร์แล้ว ลองใช้งานได้เลย!';
