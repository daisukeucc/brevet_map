...
class _MyHomePageState extends ConsumerState<MyHomePage>
  ...
  Widget _buildOfflineLayout(BuildContext context, VoidCallback onRetry) {
    ...
    return MapScreenContent(
      ...
      onOfflineMapTap: _onOfflineMapTap,
  ...
  Future<void> _onOfflineMapTap() async {
    final l10n = AppLocalizations.of(context)!;
    ...
    showDialog<void>(
      ...
      builder: (ctx) => _OfflineMapDownloadDialog(
        storeName: 'mapStore',
        region: region,
        onComplete: () {
...
class _OfflineMapDownloadDialog extends StatefulWidget {
  const _OfflineMapDownloadDialog({
  ...
  @override
  State<_OfflineMapDownloadDialog> createState() =>
      _OfflineMapDownloadDialogState();
}

class _OfflineMapDownloadDialogState extends State<_OfflineMapDownloadDialog> {
  double _progress = 0;
